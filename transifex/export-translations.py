...
# list of modules generated with
# >>> l = glob.glob('addons/*/__init__.py')
# >>> modules = set(os.path.basename(os.path.dirname(i)) for i in l if ('l10n_' not in i and 'theme_' not in i))
# >>> ",".join(list(modules))

# without 'web' that should be exported individually
